package json.templates.currentWeather;

import json.templates.currentWeather.inner.Main;
import json.templates.currentWeather.inner.Weather;
import json.templates.currentWeather.inner.Wind;
